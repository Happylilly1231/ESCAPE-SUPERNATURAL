...
public class PlayerCameraController : MonoBehaviour
{
    ...
    private PlayerController playerController; //REFERENCE TO MAIN SCRIPT
    private CapsuleCollider playerCollider; //REFERENCE TO PLAYER BOX COLLIDER
    ...
    void Awake()
    {
        ...
        playerCollider = playerController.col;
    ...
    private void GetInputs()
    {
        ...
        tiltInput = Input.GetAxisRaw("Mouse Y");
    ...
    private void ControlCamera()
    {
        ...
        Vector3 boxColliderCenter = player.transform.position + playerCollider.center;
